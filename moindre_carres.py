...
nbrFeatures = 1 #== k / ne marche que pour k=1
...
Ik = np.ones( (nbrFeatures, nbrFeatures) )
...
for u in range(m):
    ...
    X2[u] = Inv.dot(z) # ne fonctionne que si A inversible cequi nest pas notre cas
